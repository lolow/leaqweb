...
$.widget("ui.multiselect", {
  options: {
	...
	_create: function() {
		...
		this.selectedActions = $('<div class="actions ui-widget-header ui-helper-clearfix"><span class="count">'+'items selected'+'</span><a href="#" class="remove-all">'+'Remove All'+'</a></div>').appendTo(this.selectedContainer);
		this.availableActions = $('<div class="actions ui-widget-header ui-helper-clearfix"><span class="busy">'+'please wait...'+'</span><input type="text" class="search ui-widget-content ui-corner-all"/><a href="#" class="add-all">'+'Add All'+'</a></div>').appendTo(this.availableContainer);
		...
		// set dimensions
		this.container.width(this.element.width()+120);
